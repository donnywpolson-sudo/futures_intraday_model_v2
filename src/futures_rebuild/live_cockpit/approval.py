...
PLAN_SCHEMA = "futures_live_cockpit_smoke_plan/1.0.0"
APPROVAL_SCHEMA = "futures_live_cockpit_smoke_approval/1.0.0"
OPERATION = "RUN_BOUNDED_OBSERVATION_ONLY_DATABENTO_SMOKE"
