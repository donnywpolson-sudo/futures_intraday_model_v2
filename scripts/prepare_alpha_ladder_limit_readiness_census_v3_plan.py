"""Prepare only the transition-stable V3 readiness census plan."""
...
from futures_rebuild.alpha_ladder_limit_readiness_v3 import PLAN_PATH, build_plan, load_plan
...
if __name__ == "__main__":
    path = ROOT / PLAN_PATH
    if path.exists():
        raise FileExistsError("limit-readiness V3 plan already exists")
