"""Execute the authoritative approved trial and seal unpublished evidence."""
...
from futures_rebuild.tier1_authoritative_execution import (
    ...
    execute_authorized_authoritative, load_authoritative_execution_plan,
    load_authoritative_registered_context,
)
...
def main() -> None:
    ...
    execution = execute_authorized_authoritative(
