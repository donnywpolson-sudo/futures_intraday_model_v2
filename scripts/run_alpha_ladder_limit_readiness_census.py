"""Describe the resting-limit readiness scope; never execute real history."""
...
from futures_rebuild.alpha_ladder_limit_readiness import load_plan, required_scope
