"""Run only an approved cash-open impulse pre-registration census."""
...
from futures_rebuild.cash_open_impulse_census import (
    OPERATION, PLAN_PATH, execute_once, load_plan, required_scope,
)
...
def main() -> None:
    ...
    print(json.dumps({
        "status": "COMPLETED_UNPUBLISHED_PRE_REGISTRATION_CENSUS",
