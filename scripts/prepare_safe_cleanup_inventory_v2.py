...
OUTPUT = Path("state/unpublished_evidence/safe_cleanup_preparation_v2/plan.json")
PREDECESSOR_OUTPUT = Path("state/unpublished_evidence/safe_cleanup_preparation/plan.json")
PREDECESSOR_SUPERSESSION = Path(
    "state/unpublished_evidence/safe_cleanup_preparation_v1_supersession.json"
)
PREDECESSOR_PLAN_ID = "e863fb72a11aa8f41e20222a3347a4cd022beb6027073059769c51d16864a146"
PREDECESSOR_PLAN_SHA256 = "7ade3a08b842ea2d0ea89d028922673492c8a058af0c37052637334ccbd9ded7"
...
def build_plan(*, root: Path = ROOT) -> dict[str, object]:
    ...
    core: dict[str, object] = {
        "schema_version": "safe_data_project_cleanup_preparation/2.0.0",
        ...
        "superseded_predecessor": {
            ...
            "reason": "SELF_OUTPUT_ENTERED_SECOND_WORKTREE_CENSUS",
