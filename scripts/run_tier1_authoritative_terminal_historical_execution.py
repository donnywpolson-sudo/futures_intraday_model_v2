"""Execute the terminal authoritative trial after separate real-data approval."""
...
from futures_rebuild.tier1_authoritative_terminal_execution import (
    execute_authorized_terminal_authoritative,
...
def main() -> None:
    ...
    trial_id, _, _, _ = load_terminal_registered_context(root=ROOT, plan=plan)
    ...
    execution = execute_authorized_terminal_authoritative(
