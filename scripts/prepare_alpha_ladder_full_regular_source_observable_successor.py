"""Create only the unpublished closure and counted full-regular successor."""
...
def main() -> int:
    ...
    successor_write = _write_once_or_verify(successor_file, successor)
    print(json.dumps({
        ...
        "successor_write": successor_write,
