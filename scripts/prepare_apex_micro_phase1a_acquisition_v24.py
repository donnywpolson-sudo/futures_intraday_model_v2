"""Create the exact volatile-capacity-safe v24 plan and source-safe audit."""
...
if __package__:
    ...
    from scripts.prepare_safe_cleanup_candidate_census_v9 import (
...
def main() -> int:
    if any(
        ...
        raise RuntimeError("v24 cleanup census, acquisition plan, or audit exists")
    head = _head()
        ...
        json.dumps(
            {
                ...
                "superseded_v23_execute_as_current": plan[
