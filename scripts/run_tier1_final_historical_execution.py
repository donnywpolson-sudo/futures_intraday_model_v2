"""Execute the final approved trial and seal complete unpublished evidence."""
...
from futures_rebuild.tier1_final_execution import (
    ...
    execute_authorized_final, load_final_execution_plan,
    load_final_registered_context,
)
...
def main() -> None:
    ...
    trial_id, _, _, _ = load_final_registered_context(root=ROOT, plan=plan)
    ...
    execution = execute_authorized_final(
