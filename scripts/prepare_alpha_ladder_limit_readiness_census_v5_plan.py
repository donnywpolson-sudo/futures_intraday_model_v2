"""Prepare only the full-certificate-replayed V5 readiness plan."""

import json
import os
from pathlib import Path
from futures_rebuild.alpha_ladder_limit_readiness_v5 import PLAN_PATH, build_plan, load_plan
...
if __name__ == "__main__":
    path = ROOT / PLAN_PATH
    if path.exists():
        raise FileExistsError("limit-readiness V5 plan already exists")
