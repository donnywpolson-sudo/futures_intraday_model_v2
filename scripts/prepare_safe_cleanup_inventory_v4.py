...
OUTPUT = Path("state/unpublished_evidence/safe_cleanup_preparation_v4/plan.json")
PREDECESSOR_OUTPUT = Path("state/unpublished_evidence/safe_cleanup_preparation_v3/plan.json")
PREDECESSOR_SUPERSESSION = Path(
    "state/unpublished_evidence/safe_cleanup_preparation_v3_supersession.json"
)
PREDECESSOR_PLAN_ID = "a7c2eb9fadab01fc43ea3e9c107c9d07abc2c08c3fe98494b410ad90148ec5d0"
PREDECESSOR_PLAN_SHA256 = "d0aee78ccd617868003cd7bb8b815f2cc9e1079a14e781c27e0ad16155087c86"
...
def _protected_inventory(root: Path, relative: str) -> dict[str, object]:
    ...
    return {
        ...
        "inventory": "DEFERRED_TO_IMMEDIATE_PRE_CLEANUP_CENSUS",
    }
...
def build_plan(*, root: Path = ROOT) -> dict[str, object]:
    ...
    core: dict[str, object] = {
        "schema_version": "safe_data_project_cleanup_preparation/4.0.0",
        ...
        "superseded_predecessor": {
            ...
            "reason": (
                "DYNAMIC_WORKTREE_PATH_BINDING_UNSUITABLE_DURING_ONGOING_AUTHORIZED_WORK"
            ),
        ...
        "worktree_preservation_policy": {
            ...
            "cleanup_plan_does_not_preapprove_any_worktree_path": True,
        },
        "cleanup_execution": {
            "performed": False,
            "files_deleted": 0,
