...
def test_v12_documentation_preserves_implementation_reality() -> None:
    ...
    assert "immutable v12 SDK-contract-safe successor" in outline
    assert "v12 may contact Databento" in outline
    ...
    assert "immutable v12 SDK-contract-safe successor" in folder_map
    assert "passing v12 preflight and committed HEAD required first" in folder_map
