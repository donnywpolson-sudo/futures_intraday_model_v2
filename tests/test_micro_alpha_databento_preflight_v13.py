...
from futures_rebuild.micro_alpha_databento_preflight_v13 import (
...
def test_v13_plan_preserves_exact_scope_and_forbids_download() -> None:
    plan = validate_plan(
...
def test_v13_preserves_v12_failure_byte_for_byte() -> None:
...
def test_v13_full_synthetic_metadata_mechanics_pass_without_download(
    tmp_path: Path,
) -> None:
...
def test_v13_documentation_preserves_implementation_reality() -> None:
    ...
    assert "v17 may contact Databento" in normalized_outline
