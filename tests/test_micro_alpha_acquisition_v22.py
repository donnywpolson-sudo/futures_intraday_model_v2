...
from futures_rebuild import micro_alpha_acquisition_v22 as acquisition
...
def test_prepare_script_supports_direct_path_execution_imports(
    ...
    namespace = runpy.run_path(
        str(script_root / "prepare_apex_micro_phase1a_acquisition_v22.py"),
...
def test_v22_plan_is_exact_annual_non_resuming_successor(
    ...
    assert acquisition.STAGING_ROOT.as_posix().endswith("apex_micro_tier01_v22")
...
def test_v22_operation_is_allowlisted_but_executor_has_no_decode_surface() -> None:
