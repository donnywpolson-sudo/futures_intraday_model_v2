...
from scripts import prepare_apex_micro_phase1b2_group_diagnostic_manifest_v2 as manifest
...
def test_group_diagnostic_manifest_v2_is_preserved_as_superseded_scope() -> None:
    ...
    with pytest.raises(IntegrityError, match="group diagnostic (worktree|commit) differs"):
        manifest.build_manifest()


def test_group_manifest_has_no_execution_cleanup_or_git_mutation_surface() -> None:
