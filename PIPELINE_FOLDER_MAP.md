...
| `NOT_IMPLEMENTED` | `configs/apex_micro_phase1b2_historical_execution_plan_v1.json`; `state/unpublished_evidence/apex_micro_phase1b2_execution_plan_v1/audit.json` | Exact create-only execution plan and audit are intentionally generated only after the executor implementation has a committed HEAD | No row-read execution authority exists yet |
