...
| `NOT_IMPLEMENTED` | `configs/apex_micro_phase1b2_historical_execution_plan_v3.json`; `state/unpublished_evidence/apex_micro_phase1b2_execution_plan_v3/audit.json` | Create-only successor plan/audit wait for the committed path-length-safe remediation HEAD | No current row-read execution authority exists |
